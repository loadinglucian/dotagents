---
name: js
description: "Detect the correct JavaScript or TypeScript package manager from lock files and use the matching install, add, run, and dlx commands. Use when working in JS/TS projects rooted at `package.json` and the accompanying lock files."
---

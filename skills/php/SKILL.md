---
name: php
description: "Apply project PHP standards including strict_types, braces on all control structures, Yoda conditions, PHPStan-friendly annotations, and Symfony-first utilities. Use when editing `**/*.php` files."
---

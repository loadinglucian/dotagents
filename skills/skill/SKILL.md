---
name: skill
description: "Write effective SKILL.md files with strong descriptions, correct naming, progressive disclosure, and skill-specific frontmatter patterns. Use when creating or editing `.claude/skills/**/SKILL.md` or `skills/**/SKILL.md`."
---

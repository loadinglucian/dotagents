---
name: prompting
description: "Write prompt and agent instruction files with semantic markdown structure, strong information ordering, examples, protocols, standards, and constraints. Use when editing `.agents/**`, `.claude/**`, `.codex/**`, `agents/**/*.md`, `commands/**/*.md`, `rules/**/*.md`, `skills/**/*.md`, `AGENTS.md`, or `CLAUDE.md`."
---
